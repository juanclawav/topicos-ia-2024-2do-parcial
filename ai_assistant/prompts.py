...
Below is the context information.
    ...
    {context_str}
    ---------------------
Based solely on this context information (not prior knowledge), provide comprehensive travel advice. When applicable, verify your advice using the available Wikipedia tool.
